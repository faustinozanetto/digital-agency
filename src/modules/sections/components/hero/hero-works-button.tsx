...
const HeroHowItWorksButton: React.FC = () => {
  return (
    <button
      type="button"
      className="flex items-center justify-center rounded-lg bg-lime-400 px-8 py-4 text-center text-lg font-semibold text-black transition-colors hover:bg-lime-500"
    >
